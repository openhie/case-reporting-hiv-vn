...
* insert Question(item[=].item[=].,patient_cs_nr,Patient case surveillance number HIV info number and MPI number,string,false)
* insert Question(item[=].item[=].,case_uid,Case UID - auto generated by Client regsitry,string,false)
* insert Question(item[=].item[=].,patient_record_uuid, Case record UUID from data source system,string,false)
