...
* item[=].item[=].item[=].item[=].item[0].answer[0].valueString = "31 Tôn Thất Thiệp, Bến Nghé, Quận 1, Thành phố Hồ Chí Minh 70000"
* item[=].item[=].item[=].item[=].item[1].linkId = "permanent"
* item[=].item[=].item[=].item[=].item[1].text = "Permanent residence"
* item[=].item[=].item[=].item[=].item[1].answer[0].valueString = "3c Ly Thuong Kiet Street, Phu Thanh Block, Tan Phu Ward"
/*
...
* item[=].item[=].item[=].answer[+].valueString = "At patient's home during a visit"
